...
namespace Employee.Migrations
{
    ...
    [Migration("20231010020327_addDb")]
    partial class addDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Employee.Entities.CurrentDeptEmp", b =>
                {
            ...
            modelBuilder.Entity("Employee.Entities.DeptEmp", b =>
                {
                    b.Property<int>("EmpNo")
                        .HasColumnType("int")
                        .HasColumnName("emp_no");
            ...
            modelBuilder.Entity("Employee.Entities.DeptEmpLatestDate", b =>
                {
                    b.Property<int>("EmpNo")
                        .HasColumnType("int")
                        .HasColumnName("emp_no");
            ...
            modelBuilder.Entity("Employee.Entities.DeptManager", b =>
                {
                    b.Property<int>("EmpNo")
                        .HasColumnType("int")
                        .HasColumnName("emp_no");
            ...
            modelBuilder.Entity("Employee.Entities.Salary", b =>
                {
                    b.Property<int>("EmpNo")
                        .HasColumnType("int")
                        .HasColumnName("emp_no");
            ...
            modelBuilder.Entity("Employee.Entities.Title", b =>
                {
                    b.Property<int>("EmpNo")
                        .HasColumnType("int")
                        .HasColumnName("emp_no");
            ...
            modelBuilder.Entity("Employee.Entities.UserApp", b =>
                {
            ...
            modelBuilder.Entity("Employee.Entities.DeptEmp", b =>
                {
                    b.HasOne("Employee.Entities.Department", "DeptNoNavigation")
                        .WithMany("DeptEmps")
                    ...
                    b.HasOne("Employee.Entities.Employee", "EmpNoNavigation")
                        .WithMany("DeptEmps")
                        .HasForeignKey("EmpNo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
